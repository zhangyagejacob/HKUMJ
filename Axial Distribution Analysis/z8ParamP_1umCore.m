...
for i = 1 : length( dirs_2 )
    ...
    for j = 1 : length( dirs_3 )
        ...
        for k = 1:length(dirs_4)
            ...
            dir_file_CH1_Ppara = fullfile(dir_name_4, 'P-Parameter-CH1-1um-Amended-2015-11-5.txt');
            dir_file_CH2_Ppara = fullfile(dir_name_4, 'P-Parameter-CH2-1um-Amended-2015-11-5.txt');
            dir_file_CH3_Ppara = fullfile(dir_name_4, 'P-Parameter-CH3-1um-Amended-2015-11-5.txt');
