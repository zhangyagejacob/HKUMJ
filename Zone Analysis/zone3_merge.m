...
for i = 1 : length( dirs_2 )
    ...
    for j = 1 : length( dirs_3 )
        ...
        for k = 1:length(dirs_4)
            ...
            dir_file_CH3_zone = fullfile(dir_name_4, 'Zone_Analysis_Channel3.txt');
            zone_CH1 = [];
            zone_CH2 = [];
            zone_CH3 = [];
            for l = 1:length(dirs_5)
                ...
                for m = 1:length(dirs_6)
                    ...
                    Z4zone_CH3 = importdata(fullfile(dir_name_6,'CH3_Zone_Analysis.txt'));
                    zone_CH1 = [zone_CH1;Z4zone_CH1];
                    zone_CH2 = [zone_CH2;Z4zone_CH2];
                    zone_CH3 = [zone_CH3;Z4zone_CH3];
                end
            end
            ...
            fid = fopen(dir_file_CH3_zone, 'wt');
            fprintf(fid,'%8s %8s\n','NP','PIR');
            fclose(fid);
            dlmwrite(dir_file_CH3_zone, zone_CH3, '-append', 'delimiter', ' ', 'precision', 10);
        end
    end      
end
