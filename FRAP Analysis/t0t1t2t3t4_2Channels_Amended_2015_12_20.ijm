...
run("Duplicate...", "title=c123 duplicate channels=1-2");
selectWindow(icsids);
close();
...
run("Duplicate...", "title=c123 duplicate channels=1-2");
run("Split Channels");	/* Programs might make mistakes here */

print("<<programs reaches here>>");	
roiManager("reset");
...
run("Merge Channels...", "c1=[Reslice of C1-c123] c2=[Reslice of C2-c123] create");
