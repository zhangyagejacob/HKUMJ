...
%CH1
CH1RAW = importdata('./zone2/CH1-zone2.txt');
...
dlmwrite ('./zone2/0FRAP-BKC-CH1-zone2.txt', BleachCorrectionCH1, 'precision', 15);



%CH2
CH2RAW = importdata('./zone2/CH2-zone2.txt');
...
dlmwrite ('./zone2/0FRAP-BKC-CH2-zone2.txt', BleachCorrectionCH2, 'precision', 15);


%CH3
CH3RAW = importdata('./zone2/CH3-zone2.txt');
...
dlmwrite ('./zone2/0FRAP-BKC-CH3-zone2.txt', BleachCorrectionCH3, 'precision', 15);
