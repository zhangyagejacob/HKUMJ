...
%                     %CH3
%                     dir_file_3 = fullfile(dir_name_6,'CH3-zone1.txt');
%                     CH3RAW = importdata(dir_file_3);
%                     cytoCH3 = importdata(fullfile(dir_name_5,'./cytosol/cyto-CH3.txt'));
%                     %x:         mCherry=1, GFP=2, BFP2-urtch=3,        (x,3)
...
%                     dlmwrite (fullfile(dir_name_5,dirs_6(m).name,'FRAP-BKC-CH3-zone1.txt'), BleachCorrectionCH3, 'precision', 15);
                end
            end
        end
    end      
